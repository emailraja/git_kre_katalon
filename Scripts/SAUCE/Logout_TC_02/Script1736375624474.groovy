...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Swag Labs/a_Logout'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/a_Logout'), 'Logout')
